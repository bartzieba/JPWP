...
public class Transakcje extends User {
    ...
    public Transakcje(User client, String ao, String nk, String kw, String tyt,String typTrans){
     ...
     public  String zmianaStanu (String stanKonta, String login, int typZmiany)throws SQLException,ClassNotFoundException, NumberFormatException{
        try {

            int stan1 = Integer.parseInt(stanKonta);
            int zmiana = Integer.parseInt(kwota);
            if(zmiana<=0) throw new NumberFormatException();
            else if (typZmiany > 0) {
                stan1 = stan1 + zmiana;
